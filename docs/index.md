...
`pup-down` brings a Python repository up to a managed professional baseline.
...
`pup-down` makes the shared parts explicit, repeatable, and reviewable.

## Design Model

`pup-down` separates repository maintenance into three concerns:
